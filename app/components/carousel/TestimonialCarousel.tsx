...
const TestimonialCarousel = () => {
  ...
  return (
    <div className="relative max-w-5xl mx-auto overflow-hidden bg-white dark:bg-black py-16">
      {/* Left shadow overlay */}
        ...
        >
          {[...testimonials, ...testimonials, ...testimonials].map((testimonial, index) => (
            <div
              ...
              className="inline-block w-[350px] flex-shrink-0 bg-gray-50 dark:bg-neutral-900 rounded-xl p-6 shadow-md"
            >
